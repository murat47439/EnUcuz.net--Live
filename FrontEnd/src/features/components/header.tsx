...
import { UserRound, LogOut, PackageIcon, Heart, LucidePlusCircle, Handshake } from "lucide-react";
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200/60 rounded-xl shadow-xl z-50 overflow-hidden">
                  <div className="p-1.5">
                    <ul className="flex flex-col text-gray-700 select-none text-sm gap-0.5">
                      ...
                      <li>
                        <Link href="/profile/tekliflerim" onClick={handleDropdownClose} className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg hover:bg-purple-50 transition-colors">
                          <div className="w-7 h-7 rounded-lg bg-purple-100 flex items-center justify-center flex-shrink-0">
                            <Handshake size={14} className="text-purple-600" />
                          </div>
                          <span className="font-medium text-sm">Tekliflerim</span>
                        </Link>
                      </li>
