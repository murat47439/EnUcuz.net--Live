...
export default function FavoritePage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-xl font-semibold text-gray-900 mb-6">Favori Ürünlerim</h1>
      {products?.length > 0 ? (
      ...
      ) : (<p className="text-center border border-gray-200 rounded-lg mt-4 p-6 text-sm text-gray-500 bg-white">Henüz favorilere ürün eklemediniz.</p>)
      }
    </main>
  )
}